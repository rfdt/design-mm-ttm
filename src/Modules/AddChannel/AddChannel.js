...
function AddChannel({close, visible}) {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (data) => {
            ...
            if(response){setIsSuccessAdded(true)}
        }
    });
        ...
        >
            <div className="EditChannel__InnerContainer">
                <form onSubmit={formik.handleSubmit}>
                    {Object.keys(formik.errors).length > 0  ? <p className="p-error">Не все поля заполнены</p> : null}
                            ...
                            <div className="EditChannel__Form-Container">
                                ...
                                <div className="EditChannel__Form-Row">
                                    ...
                                    <div className="EditChannel__Form-Input">
                                        ...
                                        <Dropdown style={{width: "32%"}}
                                                  options={[{name: 'Крым', code: 'crimea'}, {name: 'Север', code: 'north'}]}
                                                  value={{name: formik.values.channel_region === 'crimea' ? "Крым" : "Север", code: formik.values.channel_region}}
                                ...
                                <div className="EditChannel__Form-Row">
                                    ...
                                    <div className="EditChannel__Form-Input EditChannel__Form-Input-Address">
                                        <AutoComplete value={formik.values.city} suggestions={filteredCitySuggestions}
                    ...
                    <Button label="Сохранить" icon="pi pi-check" className="EditChannel__Submit-Btn" size={"small"} type="submit"/>
                </form>
            </div>
        </Dialog>
    );
